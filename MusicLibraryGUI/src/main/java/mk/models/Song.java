...
public class Song {
     ...
     */
    public Song(String songTitle, String authorName, String authorSurname, String songAlbum, LocalDate songRelease, int songTime) {
     ...
     */
    public LocalDate getSongRelease() {
        return songRelease;
    }
     ...
     */
    public void setSongRelease(LocalDate songRelease) {
        this.songRelease = songRelease;
    }
